...
package com.bhsoft.ar3d.ui.main.camera_detect_activity.common.samplerender.arcore

import android.media.Image
import android.opengl.GLES30
import com.bhsoft.ar3d.ui.main.camera_detect_activity.common.samplerender.*
...
class BackgroundRenderer(render: SampleRender?) {
    ...
    fun setUseDepthVisualization(render: SampleRender?, useDepthVisualization: Boolean) {
        ...
        backgroundShader = if (useDepthVisualization) {
            ...
            Shader.createFromAssets(
                ...
                .setTexture("u_CameraColorTexture", colorTexture)
                .setDepthTest(false)
                .setDepthWrite(false)
        }
    }
    ...
    fun drawVirtualScene(
        ...
        if (useOcclusion) {
            occlusionShader
                ?.setTexture("u_VirtualSceneDepthTexture", virtualSceneFramebuffer.colorTexture!!)
